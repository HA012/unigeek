...
#include "utils/network/FileServiceScanUtil.h"
...
private:
  ...
  FileServiceScanUtil::Result _results[FileServiceScanUtil::MAX_RESULTS];
  ...
  void _append(const FileServiceScanUtil::Result& result);
