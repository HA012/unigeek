...
bool TelnetClientScreen::_terminalWriteThunk(void* context, const uint8_t* data, size_t len) {
  return context && static_cast<TelnetClientScreen*>(context)->_sendTerminalBytes(data, len);
}

bool TelnetClientScreen::_sendTerminalBytes(const uint8_t* data, size_t len) {
